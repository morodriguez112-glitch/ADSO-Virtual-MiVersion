...
//psvm
void main() {
    String nombre = JOptionPane.showInputDialog("Ingresar nombre del estudinte") ;
...
//condicion
    if (promedio <3.0) {
        JOptionPane.showMessageDialog(null, "El estudiante " + nombre + " esta en riesgo");
    }
        else {
            JOptionPane.showMessageDialog(null, "El estudiante " + nombre + " no esta en riesgo");
        }
    }